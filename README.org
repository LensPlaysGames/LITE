...
For now, there is no way to create a new instance of a struct.
I understand this isn't how structures are expected to work.
This is a WIP and the API to copy atoms is not there yet, but as soon
as it is, we will add the capability to get a new instance of a
